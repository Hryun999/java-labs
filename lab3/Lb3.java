...
public class Lb3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4 = new javax.swing.JLabel(); // Размер коллекции
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (selectedRow >= 0) {
            try {
                ...
                // Проверяем корректность данных перед вычислением
                RecIntegral.validateStep(n);
                ...
                showError("Ошибка в данных строки! Введите корректные числа.");
            } catch (IntegralException ex) {
                showError(ex.getMessage());
            }
        } else {
    ...
    // очистить таблицу (только отображение, коллекция сохраняется)
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new Lb3().setVisible(true));
    }
